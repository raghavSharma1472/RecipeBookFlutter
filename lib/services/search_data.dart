...
import 'package:recipe_book_flutter/screens/product/components/category_list.dart';
...
class _SearchDataState extends State<SearchData> {
  ...
  void getData () async{
    var pp = await fun();
    print(pp.length);
    Navigator.push(context,MaterialPageRoute(builder: (c) =>SearchResult(pp)));
  }
      ...
      body: Container(
        ...
        child: new Center(
          child: new Column(
            ...
            children: <Widget>[
              new Text('WAIT While We Spice up your search')
            ],
          ),
        ),
      ),
